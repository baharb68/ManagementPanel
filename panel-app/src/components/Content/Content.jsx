...
import mail from '../img/statistics-mail.png'
import shop from '../img/statistics-shoping.png'
import user from '../img/statistics-users.png'
import task from '../img/statistics-tasks.png'
...
export default class Content extends Component {
    render() {
        return (
            <div className="bg-white px-md-4 py-md-5 d-flex flex-column flex-md-row">
